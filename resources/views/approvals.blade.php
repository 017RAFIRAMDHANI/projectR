...
@foreach ($visitors as  $visitor)
                   <tr id="permit-VD001" class="visitor-permit permit-item" >
                    ...
                    <td class="px-4 py-2">{{ $visitor->purpose_detail ?? '' }}</td>
<td class="px-4 py-2">
    {{ \Carbon\Carbon::parse($visitor->request_date_from)->format('d/m/Y') ?? 'N/A' }} -
    {{ \Carbon\Carbon::parse($visitor->request_date_to)->format('d/m/Y') ?? 'N/A' }}
</td>
...
<select
  ...
  @foreach ($vendors as  $vendor)
                 ...
                 <td class="px-4 py-2">
    {{ \Carbon\Carbon::parse($vendor->validity_date_from)->format('d/m/Y') ?? 'N/A' }} -
    {{ \Carbon\Carbon::parse($vendor->validity_date_to)->format('d/m/Y') ?? 'N/A' }}
</td>
