...
@section('content')
  ...
  <div class="stat-card bg-white p-6 rounded-lg shadow-sm">
    <div class="flex flex-col items-start">
      <h3 class="text-gray-500 text-sm font-medium">Active Visitor Today</h3>
      <div class="flex items-center space-x-2 mt-2">
  ...
  <div class="stat-card bg-white p-6 rounded-lg shadow-sm">
    <div class="flex flex-col items-start">
      <h3 class="text-gray-500 text-sm font-medium">Expected Permits Next Week</h3>
      <div class="flex items-center space-x-2 mt-2">
  ...
  <div class="stat-card bg-white p-6 rounded-lg shadow-sm">
    <div class="flex flex-col items-start">
      <h3 class="text-gray-500 text-sm font-medium">Expected Visitor Next Week</h3>
      <div class="flex items-center space-x-2 mt-2">
  ...
  <div class="stat-card bg-white p-6 rounded-lg shadow-sm">
    <div class="flex flex-col items-start">
      <h3 class="text-gray-500 text-sm font-medium">Pending Permit Approval</h3>
      <div class="flex items-center space-x-2 mt-2">
  ...
  <div class="stat-card bg-white p-6 rounded-lg shadow-sm">
    <div class="flex flex-col items-start">
      <h3 class="text-gray-500 text-sm font-medium">Expiring Safety Induction (30 Days)</h3>
      <div class="flex items-center space-x-2 mt-2">
        <p class="text-3xl font-bold text-red-600">{{$safetiCount ?? ''}}</p>
