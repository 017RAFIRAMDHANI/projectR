  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex flex-col items-center justify-center py-12">
    ...
    <div class="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8 mb-8">
      <div class="flex flex-col space-y-4">
        <button onclick="window.location.href='{{route('visitor-dashboard')}}'" class="w-44 h-24 bg-white border-2 border-primary text-primary text-lg font-semibold rounded-lg shadow hover:bg-primary hover:text-white transition">
          Visitor
        </button>
      ...
      <div class="flex flex-col space-y-4">
        <button onclick="window.location.href='{{route('vendor-dashboard')}}'" class="w-44 h-24 bg-white border-2 border-primary text-primary text-lg font-semibold rounded-lg shadow hover:bg-primary hover:text-white transition">
          Vendor
        </button>
