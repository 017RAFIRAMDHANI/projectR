...
class VendorList extends Component
{
    ...
    {
        return view('livewire.vendor-list')->with('values', $this->values);
    }

    // Use polling to automatically refresh data every X seconds
    public function getListeners()
    {
        return [
            "refreshVendorList" => "fetchData", // Refresh the data every time the interval expires
        ];
    }

    public function refreshData()
    {
        $this->fetchData(); // Refresh data using Livewire's polling
    }
}
